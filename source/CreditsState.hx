...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Engine Shoutouts'],
			['shubs', 'shubs', 'Made Forever Engine, Main Inspiration', 'https://github.com/Yoshubs/Forever-Engine-Legacy', '4494E6'],
			['XtraXD1', 'placeholder', 'Made Mic´d Up Engine, Winning Icons', 'https://github.com/Verwex/Funkin-Mic-d-Up-SC', '31b0d1'],
			[''],
			['Psych Engine Team'],
